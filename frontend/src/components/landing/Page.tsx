...
const PATRONS: PersonInfo[] = [
  ...
  },
  {
    ...
    photoFilename: 'mulakhmetov.webp'
  },
  {
    firstNameRu: 'Даниил',
    lastNameRu: 'Лашин',
