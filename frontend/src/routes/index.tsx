    ...
    <div className="landing font-landing w-full bg-[#f4f4f4] flex flex-col items-stretch justify-center pb-20 font-normal text-base">
      <div className='px-8 mx-auto pt-10 mb-30'>
        ...
        <div className='text-center mt-20 md:mt-30 space-y-8 mb-20'>
          <h2 className='opacity-25'>Стипендия</h2>
          <div className='relative pointer-events-none select-none w-full'>
            <Text1519 className='w-[250px] md:w-[468px] h-auto mx-auto' aria-label='1519' role='heading' />
        ...
        <button className='mx-auto cursor-pointer max-w-96 w-full rounded-[100%] text-center h-[30px] flex items-center justify-center border border-black'>Податься</button>
      </div>
      <section>
        ...
        <div className='text-center flex flex-col items-center gap-6'>
          <p className='leading-none'>30 стипендий<br/>12 000 руб/месяц</p>
          <span className="inline-block w-2 h-2 bg-black rounded-full"></span>
          <p className='leading-none'>в течение 6 месяцев</p>
        </div>
        <div className='text-lg md:text-2xl grid grid-cols-[1fr_auto_1fr] items-center w-fit mx-auto gap-6 md:gap-10 my-20'>
          <div className='flex gap-1'>
            <div className='relative h-[80px] md:h-[100px]'>
              <LetterC className='h-full w-auto' />
              <Picture
                w={128}
                h={128}
          ...
          <span className="inline-block w-2 h-2 bg-black rounded-full"></span>
          <p className='leading-none text-center'>01.09.2025<br/>–<br/>21.09.2025</p>
        </div>
        <Picture
          w={128}
          h={128}
      ...
      <section>
        <SectionIntro>
          <div className='flex items-end justify-center'>
            <div className='relative h-[80px] md:h-[100px]'>
              <LetterO className='h-full w-auto' />
              <Picture
                w={128}
                h={128}
            ...
            <span className='text-lg md:text-2xl'>рганизаторы</span>
          </div>
        </SectionIntro>
      ...
      <section>
        <SectionIntro className='mb-20'>
          <div className='flex items-end justify-center'>
            <div className='relative h-[80px] md:h-[100px]'>
              <LetterM className='inline-block h-full w-auto' />
              <Picture
                w={128}
                h={128}
                srcPng={patterns3_128_png}
            ...
            <span className='text-lg md:text-2xl'>еценаты</span>
          </div>
        </SectionIntro>
        <div className='flex flex-wrap justify-center max-w-[calc(160px*4+24px*3)] [&>*]:w-[160px] gap-[24px] my-20 mx-auto'>
        ...
        <p className='text-center opacity-25'>
          По всем вопросам — <a href='https://www.youtube.com/watch?v=dQw4w9WgXcQ' className='underline underline-offset-2'>сюда</a>
        </p>
      </section>
