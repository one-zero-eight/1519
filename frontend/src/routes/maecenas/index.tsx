...
function RouteComponent() {
    ...
    const patronsList = patrons ? patrons.map((patron) => (
        <div key={patron.ranking.patron_id} className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-gray-50 rounded-xl p-4 sm:p-5 gap-3 sm:gap-0">
